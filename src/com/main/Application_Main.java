		...
		SearchAll search=new SearchAll();
		 int c=0;
			...
			{   System.out.println("****************************E-COMMERCE*****************************"); 
				System.out.println("************************!!!Sport StudioS!!!************************");
			    System.out.println("===================================================================");
				System.out.print("1>Display All Users");
				System.out.print("     2>Display All Products");//select * from user;
				System.out.println("      3>Display All Orders");
				
				System.out.print("4>Search User");//select * from user where uname="pooja";
				System.out.print("           5>Search Product");
				System.out.println("            6>Search Order");
				
				System.out.print("7>Update User");//update user set uname="ppoja" where city="nashik";
				System.out.println("            8>Update Product");
				
				System.out.print("9>Delete User");//delect  from user where uname="pooja";
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		do
		{
			...
			case 3:
				...
				if((adminUserName.equals("GroupE1") && adminPassword.equals("admin")))
				{   
					System.out.println("    login Successful!!!!");
					adminMenu();	
				}
